...
@section('content')
    ...
    <div class="card mt-3 p-4">
        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="post" id="category_update">
            @csrf
            @method('PUT')
            <div class="row">
...
@section('scripts')
    {!! JsValidator::formRequest('App\Http\Requests\Admin\UpdateCategoryRequest', '#category_update') !!}
